...
CREATE TABLE `articles` (
  ...
  CONSTRAINT `fk_Articles_Authors1` FOREIGN KEY (`Authors_id`) REFERENCES `authors` (`id`),
  CONSTRAINT `fk_Articles_Category1` FOREIGN KEY (`Category_id`) REFERENCES `category` (`id`)
...
INSERT INTO `authors` VALUES (1,'Richard','Louis');
...
INSERT INTO `category` VALUES (1,'Business'),(2,'Culture'),(3,'Sport'),(4,'Guerre en Ukraine');
...
-- Dump completed on 2022-05-23 15:33:42
