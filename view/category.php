      ...
      <div class="col-md-12" data-aos="fade-up">
        <?php foreach ($category as $singleArticle) { ?>
          <div class="d-md-flex post-entry-2 half">
            <a href="index.php?action=showArticle&aid=<?=$singleArticle['id']?>" class="me-4 thumbnail">
            ...
            <div>
              ...
              <h3><a href="index.php?action=showArticle&aid=<?=$singleArticle['id']?>"><?= $singleArticle['abstract'] ?></a></h3>
